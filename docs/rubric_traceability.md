...
| Deliverable | v1.3.1 implementation | Execution evidence |
|---|---|---|
...
| 6. Documentation & execution evidence — 5 | English README; architecture and graph docs; strict source/runtime JSON probes; executed notebook; machine-readable evidence; regression tests; incremental Git history | `README.md`, `EVALUATION.json`, `docs/automated_evaluation_guide.md`, `notebooks/ContractGuard_Capstone_Executed.ipynb`, `evidence/runtime_grader_probe.json`, Git history |
...
`tests/test_trainer_fixes.py` is a regression gate for these exact implementation requirements. `EVALUATION.json` records the same checks in machine-readable form, and `evidence/runtime_grader_probe.json` records end-to-end execution after CI installs dependencies.
